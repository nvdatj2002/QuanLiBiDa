...
public class jdlThemNhanVien extends javax.swing.JDialog {
     ...
     */
    public byte[] photo;
    public static boolean checkchucvu = false;
    ...
    private void btnluuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnluuActionPerformed
        if (txttennv.getText().equals("")) {
            ...
            if ((namhientai - namsinh < 16)) {
                ...
                NhanVien nv = new NhanVien(tennv, ngaysinh, chucvu, sdt, email, diachi, gioitinh, luong, tendn, mk, img, tinhtrang);
                BLL.BLLNhanVien.add(nv,email);
                loadnhanvien();
            }
