...
import static BLL.BLLPhieuNhap.LayTinhTrangPhieuNhapbyMa;
 ...
 * @author Admin
 */
public class pnlNhap extends javax.swing.JPanel {
    ...
    public static void LoadTableChiTietByMa() {
        ArrayList<ChiTietPhieuNhap> arr = BLL.BLLPhieuNhap.GetAllCTPNbyMa(MaPhieuNhap);
        BLL.BLLPhieuNhap.DoVaoTable(arr, tbchitiet);
    }

    public static void LoadTablePhieuNhap() {
        ArrayList<PhieuNhap> arr = BLL.BLLPhieuNhap.GetAllPN();
        new BLLPhieuNhap().DoVaoTablePhieuNhap(arr, tbphieuthu);
    }

    public static void DemPhieu() {
        boolean tinhtrang = false;
        int dem = BLLPhieuNhap.DemPhieuNhap(tinhtrang);
        if (dem < 1) {
    ...
    private void txttimkiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimkiemKeyReleased
        ...
        ArrayList<PhieuNhap> arrdv = BLL.BLLPhieuNhap.FindPhieuNhap(input, input);
        new BLLPhieuNhap().DoVaoTablePhieuNhap(arrdv, tbphieuthu);
    ...
    private void btntaophieuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntaophieuActionPerformed
        ...
        switch (JOptionPane.showConfirmDialog(null, ten, "Nhập tên: ", JOptionPane.YES_NO_OPTION)) {
            case JOptionPane.YES_NO_OPTION:
                ...
                double tongtien = 0;
                boolean tinhtrang = false;
                PhieuNhap pn = new PhieuNhap(ten.getText(), nguoitao, tongtien, tinhtrang);
                BLL.BLLPhieuNhap.TaoPhieuNhap(pn);
                DemPhieu();
                LoadTablePhieuNhap();
                break;
    ...
    private void btnxongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxongActionPerformed
        int MaPhieuThu = BLL.BLLPhieuNhap.LayMaPhieuNhap();
        double tongtien = BLL.BLLPhieuNhap.LayTongTien(MaPhieuThu);
        boolean tinhtrang = true;
        BLLPhieuNhap.UpdateTinhTranggPhieuNhap(tongtien, tinhtrang, MaPhieuThu);
    ...
    private void tbphieuthuMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbphieuthuMousePressed
        ...
        MaPhieuNhap = Integer.parseInt(tbphieuthu.getValueAt(index, 1).toString());
        LoadTableChiTietByMa();
        int indexColumn = tbphieuthu.getSelectedColumn();
        if (!LayTinhTrangPhieuNhapbyMa(MaPhieuNhap)) {
            if (evt.getButton() == MouseEvent.BUTTON1 && indexColumn == 7) {
                jdlThemChiTietPhieuNhap jdl = new jdlThemChiTietPhieuNhap(new HomeScreen(), true);
                jdl.setVisible(true);
            }
        }
