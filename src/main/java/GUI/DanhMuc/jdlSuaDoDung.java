...
import static GUI.DanhMuc.pnlDoDung.vitri;
 ...
 * @author Admin
 */
public class jdlSuaDoDung extends javax.swing.JDialog {
    ...
    public jdlSuaDoDung(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void LoadWhenOpen() {
        ArrayList<DoDung> arrdd = BLL.BLLDoDung.FindbyMaDoDung(MaDoDung);
        for (DoDung dd : arrdd) {
            txtten.setText(dd.getTenDoDung());
            
            txtgianhap.setText(Transform.SoString(dd.getGiaNhap()));
            txtgiaban.setText(Transform.SoString(dd.getGiaBan()));
            if (dd.isTinhTrang()) {
            ...
            spnsoluong.setValue(dd.getSoLuong());
            photo = dd.getHinhAnh();
        ...
        BLL.BLLKhac.LoadCBBKhiMo(cbloaidodung, BLL.BLLKhac.loadTenLSP(arrdd.get(0).getLoaiDoDung()));
        BLL.BLLKhac.LoadCBBKhiMo(cbdvt, BLL.BLLKhac.loadTenDVT(arrdd.get(0).getDonViTinh()));
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(btnhinhanh, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(28, 28, 28)
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnluuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnluuActionPerformed
        if (txtten.getText().equals("")) {
            ...
            int madd = Integer.parseInt(tbdodung.getValueAt(vitri, 1).toString());
            ...
            DoDung dd = new DoDung(TenMoi, MaLoai, gianhap, giaban, soluong, DVT, tinhtrang, img);
            BLL.BLLDoDung.SuaDoDung(dd,madd);
            LoadDoDung();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        this.dispose();
        jdlLoaiDoDung jdl = new jdlLoaiDoDung(new HomeScreen(), true);
        jdl.setVisible(true);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        this.dispose();
        jdlDonViTinh jdl = new jdlDonViTinh(new HomeScreen(), true);
        jdl.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdlSuaDoDung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdlSuaDoDung dialog = new jdlSuaDoDung(new javax.swing.JFrame(), true);
