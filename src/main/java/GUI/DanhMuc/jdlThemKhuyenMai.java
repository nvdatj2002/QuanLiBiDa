 ...
 * @author Admin
 */
public class jdlThemKhuyenMai extends javax.swing.JDialog {

    /**
     * Creates new form jdlThemban
     */
    public jdlThemKhuyenMai(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdlThemKhuyenMai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdlThemKhuyenMai dialog = new jdlThemKhuyenMai(new javax.swing.JFrame(), true);
